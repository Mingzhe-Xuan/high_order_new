...
class HighOrderGMTNet(nn.Module):
    def __init__(
        ...
        if getattr(args, "use_cgcnn", False):
            atom_feature_dim = 92
        else:
            atom_feature_dim = 118
    ...
    def _atom_features(self, atom_type):
        ...
        # if num_classes != 118:
        #     raise ValueError(
        #         "HighOrderGMTNet expects atomic-number inputs to be one-hot encoded "
        #         "with gmtnet_atom_feature_dim=118 unless the dataloader provides "
        #         "CGCNN features directly."
        #     )
